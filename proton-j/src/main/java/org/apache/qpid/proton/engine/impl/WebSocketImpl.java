...
public class WebSocketImpl implements WebSocket {
    private int _maxFrameSize = (4 * 1024) +
    ...
    public void configure(String host, String path, int port, String protocol,
        Map<String, String> additionalHeaders, WebSocketHandler webSocketHandler) {
        _host = host;
        _path = path;
        _port = port;
        _protocol = protocol;
    ...
    public TransportWrapper wrap(final TransportInput input,
        ...
        return new WebSocketSniffer(new WebSocketTransportWrapper(input, output),
    ...
    public String toString() {
        ...
        builder.append("WebSocketImpl [isWebSocketEnabled=")
               .append(_isWebSocketEnabled).append(", state=").append(_state)
               .append(", protocol=").append(_protocol).append(", host=")
               .append(_host).append(", path=").append(_path).append(", port=")
               .append(_port);
    ...
    protected void writeUpgradeRequest() {
        ...
        String request = _webSocketHandler.createUpgradeRequest(_host, _path,
                _port, _protocol, _additionalHeaders);
    ...
    private class WebSocketTransportWrapper implements TransportWrapper {
        ...
        private WebSocketTransportWrapper(TransportInput input,
            ...
            if (_isWebSocketEnabled) {
                ...
                case PN_WS_CONNECTED_FLOW:
                    ...
                    if (_underlyingOutputSize > 0) {
                        ...
                        _webSocketHeaderSize = _outputBuffer.position() -
                            _underlyingOutputSize;
