...
public class WebSocketSnifferTest
{
    ...
    public void testMakeDetermination_wrapper1()
    {
        ...
        bytes[0] = WebSocketHeader.FINALBINARYHEADER[0];

        webSocketSniffer.makeDetermination(bytes);
        assertEquals("Incorrect wrapper selected", mockTransportWrapper1, webSocketSniffer._selectedTransportWrapper);
    }
    ...
    public void testMakeDetermination_wrapper2()
    {
        ...
        webSocketSniffer.makeDetermination(bytes);
        assertEquals("Incorrect wrapper selected", mockTransportWrapper2, webSocketSniffer._selectedTransportWrapper);
    }
